...
MESOIGNER_HEADERS = {
    "Authorization": f'Mesoigner apikey='${{secrets.MESOIGNER_API_KEY}},
}
...
def scrap_centers():
    ...
    logger.info(f"[Mesoigner centers] Parsing centers from API")
    try:
...
def set_center_type(center_type: str):
    center_types = MESOIGNER_CONF.get("center_types", {})
