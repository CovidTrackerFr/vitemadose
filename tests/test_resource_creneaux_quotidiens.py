    ...
    expected = {
        ...
        'creneaux_quotidiens': [
            ...
            { 'date': '2021-06-01', 'total': 1, 'creneaux_par_lieu': [{
                ...
                'creneaux_par_tag': [ { 'tag': 'all', 'creneaux': 1} ]
                }]
            },
            { 'date': '2021-06-02', 'total': 0, 'creneaux_par_lieu': [] },
        ]
...
def test_resource_creneaux_quotidiens__2_creneau_with_custom_tags():
    ...
    # When
    actual = next(ResourceCreneauxQuotidiens.from_creneaux(creneaux, next_days=7, departement=departement, now=now, tags=tags))
    # Then
    assert actual.asdict() == expected
