...
from scraper.pattern.center_info import CenterInfo, convert_csv_address, convert_csv_business_hours, \
    convert_ordoclic_to_center_info, convert_csv_data_to_center_info, get_last_scans
...
def test_convert_address():
    ...
    data = {
        'address': '12 Rue de la Vie, 75012 Paris'
    }
    address = convert_csv_address(data)
